...
class GridPosts extends WP_Widget {

    /*  Constructor
    /* ------------------------------------ */
      function __construct() {
        parent::__construct( false, esc_html__( 'Ruber Grid Posts', 'ruber' ), array('description' => esc_html__( 'Display posts from a category', 'ruber' ), 'classname' => 'widget_ruber_posts', 'customize_selective_refresh' => true ) );
      }
    ...
    ?>
    <div class="ruber-grid-posts row pb-5">
        <?php while ($posts->have_posts()): $posts->the_post(); ?>
        <div class="col-md-4">
            <div class="ruber-grid-post">
    ...
    ?>
      ...
      <div class="ruber-options-posts">
        ...
        <h4><?php esc_html_e( 'Grid Posts', 'ruber' ); ?></h4>
        <p>
...
// Register widget
/* ------------------------------------ */
if ( ! function_exists( 'grid_register_widget_posts' ) ) {

    function grid_register_widget_posts() {
    register_widget( 'GridPosts' );
    }

}
add_action( 'widgets_init', 'grid_register_widget_posts' );
